...
def calc_Z_error_pseudo_hessian_subelement_shg(pulse_t_dispersed, signal_t_m, signal_t_new_m, D_arr_pn, exp_arr_mn, exp_arr_mp):
...
def calc_Z_error_pseudo_hessian_subelement_thg(pulse_t_dispersed, signal_t_m, signal_t_new_m, D_arr_pn, exp_arr_mn, exp_arr_mp):
...
def calc_Z_error_pseudo_hessian_subelement_pg(pulse_t_dispersed, signal_t_m, signal_t_new_m, D_arr_pn, exp_arr_mn, exp_arr_mp):
...
def calc_Z_error_pseudo_hessian_one_m(dummy, exp_arr_m, pulse_t_dispersed, signal_t_m, signal_t_new_m, time, omega, nonlinear_method, full_or_diagonal):
