...
from pulsedjax.frog import Vanilla, LSGPA, CPCGPA, GeneralizedProjection, PtychographicIterativeEngine, COPRA
...
def test_PtychographicIterativeEngine(parameters):
    ...
    tdp = PtychographicIterativeEngine(delay, frequency, trace, nonlinear_method, pie_method, cross_correlation=cross_correlation)
    if use_spectrum==True:
