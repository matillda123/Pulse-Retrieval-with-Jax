from pulsedjax.chirp_scan import DifferentialEvolution, Evosax, LSF, AutoDiff
...
def test_DifferentialEvolution(parameters):
    ...
    de = DifferentialEvolution(z_arr, frequency, trace, nonlinear_method, phase_type = phase_matrix_material, chirp_parameters=parameters_material_scan)
...
def test_Evosax(parameters):
    ...
    evo = Evosax(z_arr, frequency, trace, nonlinear_method, phase_type = phase_matrix_material, chirp_parameters=parameters_material_scan)
...
def test_LSF(parameters):
    ...
    lsf = LSF(z_arr, frequency, trace, nonlinear_method, phase_type = phase_matrix_material, chirp_parameters=parameters_material_scan)
...
def test_AutoDiff(parameters):
    ...
    ad = AutoDiff(z_arr, frequency, trace, nonlinear_method, phase_type = phase_matrix_material, chirp_parameters=parameters_material_scan)
