from pulsedjax.tdp import DifferentialEvolution, Evosax, LSF, AutoDiff
...
delay, frequency, trace, spectra = pulse_maker.generate_tdp(time, frequency, pulse_t, pulse_f, nonlinear_method="pg", spectral_filter=None, N=46, 
